...
class Form(DandeForm):
    ...
    def __init__(
        ...
        **kwargs
        ...
        welcome_message = helper.default_label(container=self,text= "Thank you for sumbitting order!\n The one stop cake ordering tool appreciates your business! \n From the menu view current orders, in the interim someone will contact you within 24 hours?\n ",font_family=font_family)
